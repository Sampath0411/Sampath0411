...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Sampath Satya Saran — first-year CSE student shipping production-grade full-stack and AI-assisted projects." },
      { name: "author", content: "Sampath Satya Saran" },
      { property: "og:title", content: "Sampath Satya Saran — Full-Stack Developer & UI/UX Designer" },
      { property: "og:description", content: "Portfolio of Sampath Satya Saran — first-year CSE student shipping production-grade full-stack and AI-assisted projects." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Sampath Satya Saran — Full-Stack Developer & UI/UX Designer" },
      { name: "twitter:description", content: "Portfolio of Sampath Satya Saran — first-year CSE student shipping production-grade full-stack and AI-assisted projects." },
