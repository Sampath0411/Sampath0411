...
|---|---|---|
| **ResumePlus / ResumePulse** | ATS-friendly resume builder | HTML, CSS, JS |
| **Social Media Platform** | Instagram-like platform | JavaScript |
| **Tony** | Multi-language voice assistant (offline + online) | Python |
| **EventFlow** | Event creation & registration platform with QR codes, CSV export, dual roles | HTML, JS, localStorage |
| **Trackr** | PWA expense tracker | PWA, JS |
| **AU Faculty Portal** | Smart attendance, analytics, instant letter generator (hackathon demo) | HTML, CSS, JS |
...
|---|---|---|
| Instagram | [@samxeditz.56](https://instagram.com/samxeditz.56) | Video editing content |
| Instagram | [@\_exotic\_sampath.56](https://instagram.com/_exotic_sampath.56) | Personal |
